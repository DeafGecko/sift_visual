      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-background text-foreground gap-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-sm text-foreground/40">Loading {Object.keys(STOCKS).length} stocks</p>
          </div>
          ...
          <div className="grid grid-cols-5 gap-2 opacity-20 mt-4">
            {Array.from({ length: 25 }).map((_, i) => (
              <div
                key={i}
                className="w-16 h-14 rounded-xl bg-zinc-700 animate-pulse"
